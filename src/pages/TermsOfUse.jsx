    ...
    <div className="bg-bgBase min-h-screen py-24 animate-fade-in font-sans">
      <div className="max-w-[800px] mx-auto card p-10 md:p-16">
        ...
        <div className="space-y-8 text-textBody font-light leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-serif text-textMain mb-3">1. Agreement to Terms</h2>
            <p>By accessing our website and using our services, you agree to be bound by these Terms of Use and our Privacy Policy. If you do not agree with any part of these terms, you are prohibited from using our site and services.</p>
          </section>
